...
\begin{figure}
    \centering
    \subfloat{{\includegraphics[width=.5\linewidth]{images/balanceo/primeros3exp_precision_3795.png} }}%
    
    \subfloat{{\includegraphics[width=.5\linewidth]{images/balanceo/primeros3exp_recall_3795.png} }}%
    \subfloat{{\includegraphics[width=.5\linewidth]{images/balanceo/primeros3exp_f1_3795.png} }}%
...
\begin{figure}
    \centering
    \subfloat{{\includegraphics[width=.18\linewidth]{images/balanceo/digitosFeos/es0_pred6_4.png} }}%
    \subfloat{{\includegraphics[width=.18\linewidth]{images/balanceo/digitosFeos/es2_pred3_1.png} }}%
    \subfloat{{\includegraphics[width=.18\linewidth]{images/balanceo/digitosFeos/es3_pred5_9.png} }}%
    \subfloat{{\includegraphics[width=.18\linewidth]{images/balanceo/digitosFeos/es3_pred9_3.png} }}%
    
    \subfloat{{\includegraphics[width=.18\linewidth]{images/balanceo/digitosFeos/es4_pred1_1.png} }}%
    \subfloat{{\includegraphics[width=.18\linewidth]{images/balanceo/digitosFeos/es4_pred9_9.png} }}%
    \subfloat{{\includegraphics[width=.18\linewidth]{images/balanceo/digitosFeos/es7_pred1_0.png} }}%
    \subfloat{{\includegraphics[width=.18\linewidth]{images/balanceo/digitosFeos/es9_pred4_0.png} }}%
    
    \subfloat{{\includegraphics[width=.18\linewidth]{images/balanceo/digitosFeos/aMano_es1_pred7.png} }}%
    \subfloat{{\includegraphics[width=.18\linewidth]{images/balanceo/digitosFeos/aMano_es2_pred8.png} }}%
    \subfloat{{\includegraphics[width=.18\linewidth]{images/balanceo/digitosFeos/aMano_es4_pred9.png} }}%
    \subfloat{{\includegraphics[width=.18\linewidth]{images/balanceo/digitosFeos/aMano_es5_pred6.png} }}%
